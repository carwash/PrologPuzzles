/*  File: writers.pl  Author: solution Mihaela Malita
...
One is an essayist, one is an historian, one writes pamphlets, one is a novelist,
one is a playwright and poet.
...
start(S) :-
	...
	% 3. Mr. Yellow sits between the essay guy and pamphlet guy.
	nth1(Ne,S,[_,essays,_]),
	nth1(Ny,S,[yellow,_,_]),
	nth1(Np,S,[_,pamphlets,_]),
